...
public class ItemModelGenerator extends ItemModelProvider {
    ...
    protected void registerModels() {
        Arrays.asList(WalletsMod.COIN_ONE,WalletsMod.COIN_FIVE,WalletsMod.COIN_TWENTY,WalletsMod.COIN_FIFTY,WalletsMod.COIN_ONE_HUNDRED,WalletsMod.COIN_FIVE_HUNDRED).forEach(coin -> {
